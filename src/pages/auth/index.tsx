...
export function SignIn() {
  ...
  async function handleLogin(formData: SignInForm) {
    try {
      ...
      if (role === 'admin') navigate('/admin/support-center')
  ...
  return (
    <div className="flex px-2 sm:px-0 h-screen items-center justify-center">
      <div className="w-89 p-10 space-y-5 rounded-md bg-zinc-100 dark:bg-zinc-900">
        <div className="flex flex-col gap-3 items-center">
          <h2 className="bg-gradient-to-r from-[#2CACDD] to-[#0FB091] text-transparent bg-clip-text font-bold text-2xl">
            UNIFAA
          </h2>
          <p className="font-semibold">Agendamento de avaliação</p>
        </div>
